...
import '../../components/CryptoDetails/masterplanCrypto.css';
    ...
    <div class="board">
        ...
        */}
                ...
                <div class="investment-buttons">
                        <Link to='/CryptoInvestForms/masterPlanInvC' class="invest-masterCrypto">Invest</Link>
                        <Link to='/Invest/InvestPage' class="change-masterCrypto">Change Plan</Link>
                </div>
                </div>
